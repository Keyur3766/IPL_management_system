    ...
    <div class="container">
        ...
        <div class="forms">
            <form  method="POST" >
                ...
                $id = $_GET['id'];
                $selectquery = "select * from `point_table` where `team`= '$id'";
                ...
                if(isset($_POST['submit'])){
                    ...
                    $matches = $win + $lose;
                    $points = $win*2;
                    $updatequery = "update point_table set win ='$win',lose='$lose',matches='$matches',point='$points' where `team`='$id'";

                    if(mysqli_query($con,$updatequery)){
                        echo "";
                        echo "<script type='text/javascript'>alert('Points Updated, SUCCESSFULLY!!');</script>";
                        echo("<script>location.href = 'update_delete_points.php';</script>");
                ...
                ?>
                <h2>Change the details of <?php echo $result['team']?></h2>
                <label for="win">Win:</label>
                <input type="text" id="win" name="win" value="<?php echo $result['win']?>"><br><br>
                <label for="lose">Lose:</label>
                <input type="text" id="lose" name="lose" value="<?php echo $result['lose']?>"><br><br>
