...
<body>
    <div class="container">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td> <a href=team_members.php?id=" .$row["team_name"].">See Team members</a></td>
                            <td> <a href=delete_team.php?id=" .$row["team_name"]."><i class='fa fa-trash' aria-hidden='true' style='color:red'></i></a></td>
                            <td> <a href=update_team.php?id=".$row["team_name"]."><i class='fa fa-pencil-square-o' aria-hidden='true' style='color:green'></i></a></td></tr>";
                        }
                    }
                    mysqli_close($con);
                ?>
        ...
        <br>
        <br>
        <div class="addteam"><a href="addteam.php">Add Team</a></div>
    </div>
</body>
</html>
