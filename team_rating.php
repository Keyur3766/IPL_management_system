    ...
    <div class="container">
        ...
        <table>
            ...
            <?php
                ...
                $query="select team_table.team_name,sponsor.companyname,point_table.point from team_table,point_table,sponsor where team_table.team_name=point_table.team and team_table.sponsor_id=sponsor.sponser_id order by point_table.point desc";
