...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `ground_details`(`groundname`, `city`, `state`, `capacity`) VALUES ('$gname','$city','$state','$capacity')";
    $flag=0;
    $result1 = mysqli_query($con,"select count_ground('$city') as count from DUAL");
    ...
    if($count==0){
        if(mysqli_query($con,$query)){
            echo "";
            echo "<script type='text/javascript'>alert('GROUND ADDED, NEW RECORD CREATED SUCCESSFULLY!!');</script>";
            header("refresh: 0.01; url=addground.php");
        }
        ...
        $flag=1;
        $message="There could not such type of ground in this city";
    }
}
...
<body>
    <div class="container">
        ...
        <div class="forms">
            <form action="addground.php " method="POST" >
