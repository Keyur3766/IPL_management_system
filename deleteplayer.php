...
if(isset($_POST['submit'])){
    ...
    $query = "DELETE FROM `details_of_player` WHERE `cap_no` = '$capno' AND `team_name` = '$tname'";

    if(mysqli_query($con,$query)){
        echo "";
        echo "<script type='text/javascript'>alert('PLAYER removed successfully!!');</script>";
    ...
    <div class="container">
        ...
        <div class="forms">
            <form action="deleteplayer.php" method="POST" >
                ...
                <br>
                <br>
                <h4>Enter the details of the player which you want to delete</h4>
