...
<head>
    ...
    <title>update/delete Sponser</title>
</head>
<body>
    <div class="container">
        <div class="logo">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td> <a href=delete_sponser.php?id=" .$row["sponser_id"]."><i class='fa fa-trash' aria-hidden='true' style='color:red'></i></a></td>
                            <td> <a href=update_sponser.php?id=".$row["sponser_id"]."><i class='fa fa-pencil-square-o' aria-hidden='true' style='color:green'></i></a></td></tr>";
                        }
                    }
                    mysqli_close($con);
                ?>
