...
<head>
    ...
    <title>update/delete Points</title>
</head>
<body>
    <div class="container">
        <div class="logo">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td> <a href=delete_point.php?id=" .$row["team"].">Delete</a></td>
                            <td> <a href=update_point.php?id=".$row["team"].">Update</a></td></tr>";
                        }
                    }
                    mysqli_close($con);
                ?>
